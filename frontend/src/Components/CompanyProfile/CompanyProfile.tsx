...
const tableConfig = [
  ...
  },
  {
    ...
    render: (company: CompanyKeyMetrics) => formatLargeNonMonetaryNumber(company.tangibleAssetValueTTM),
    subTitle:  "Book value per share indicates a firm's net asset value (total assets - total liabilities) on per share basis",
  },
  {
    label: "Divdend Yield TTM",
    render: (company: CompanyKeyMetrics) => formatRatio(company.returnOnAssetsTTM),
